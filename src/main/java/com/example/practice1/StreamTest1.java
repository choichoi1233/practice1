...
public class StreamTest1 {
    public static void main(String[] arg) {
        List<Product> products = Arrays.asList(
                new Product("콜라", 1000),
                new Product("사이다", 5900),
                new Product("환타", 9100),
                new Product("쥬스", 1300),
                new Product("아이스크림", 1400),
                new Product("과자", 5000)
        );
        ...
        OptionalDouble averagePrice = products.stream()
                ...
                .average();
        averagePrice.ifPresentOrElse(
                avg -> System.out.println(avg),
                () -> System.out.println("평균 가격을 계산할 수 없습니다.")
        );
        ...
        OptionalInt maxPrice = products.stream()
                ...
                .max();
        maxPrice.ifPresentOrElse(
                max -> System.out.println(max),
                () -> System.out.println("가장 비싼 제품을 찾을 수 없습니다.")
        );
    }
}
